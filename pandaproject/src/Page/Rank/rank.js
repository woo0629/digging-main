...
function Rank() {
  const [bookData] = useState(bookToday);
  const [electronicData] = useState(electronicToday);
  const [fashionData] = useState(fashionToday);
  const [goodsData] = useState(goodsToday);
  const [ticketData] = useState(ticketToday);
  const [toyData] = useState(toyToday);
